            ...
            <div className="space-y-8 text-sm">
              ...
              <motion.div className="space-y-2">
                <p className="flex items-start">
                  ...
                  <span className="ml-2">
                    <span className="uppercase text-[#67e8bc]">
                      Q: What languages does Afro AI support?
                    </span>{" "}
                    A: Premium models of AI most especially ChatGpt support
                    major African languages including Swahili, Yoruba, Zulu,
                    Amharic, and more.
                  </span>
                </p>
                <p className="flex items-start">
                  ...
                  <span className="ml-2">
                    <span className="uppercase text-[#67e8bc]">
                      Q: How accurate is Afro AI's information?
                    </span>{" "}
                    A: Afro AI uses premium ChatGPT 4o and is constantly updated
                    by Open AI, which are one of the owners of the premium
                    models we use. However, always verify critical information
                ...
                <p className="flex items-start">
                  ...
                  <span className="ml-2">
                    <span className="uppercase text-[#67e8bc]">
                      Q: How accurate is Campus Genie's/Wisenurse's information?
                    </span>{" "}
                    A: Campus Genie/Wise Nurse use your lecture notes as their
                    primary knowledgebase leveragig the power of premium ChatGPT
                    4o and Claude 3.5 Sonnet AI models to interact with the
                    knowledgebase therefore they are less prone to hallucinate.
                    However, always verify critical information from official
                    sources because it is widely known that premium models do
                    hallucinate atimes.
                  </span>
                </p>
                <p className="flex items-start">
                ...
                <p className="flex items-start">
                  ...
                  <span className="ml-2">
                    <span className="uppercase text-[#67e8bc]">
                      Q: Is my data safe with Afro AI?
                    </span>{" "}
                    A: We prioritize your privacy. We don't sell your data.
                  </span>
                </p>
                <p className="flex items-start">
                  <span>6.</span>
                ...
                <p className="flex items-start">
                  ...
                  <span className="ml-2">
                    <span className="uppercase text-[#67e8bc]">
                      Q: Can I contribute to improving Afro AI? A:
                    </span>
                    Absolutely! Your usage and feedback helps us provide a
                    better user experience and in the long run will help us to
                    train the premium models to understand the nuances of
                    African culture promoting an African tailored response to
                    all African users.
                  </span>
                </p>
                <br></br>
