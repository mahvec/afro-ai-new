        ...
        <div className="h-screen w-full flex flex-col items-center justify-center bg-[#1a1a2e] text-[#dcf7ee]">
          ...
          >
            ...
            <p className="text-center mb-10">
              ...
              intelligence across Africa. Our innovative platform brings the
              power of premium AI models like ChatGPT-4o to every African at an
              affordable rate. Interact with the premium model of ChatGpt 4o
              using our AI assistant called "Afro" You can begin using it for
              any and every task.
            </p>
            ...
            <div className="space-y-8 text-sm">
              ...
              <motion.div className="space-y-2">
                <p className="flex items-start">
                  <span>●</span>
                  <span className="ml-2">
                    Affordable Access: Pay in three African currencies, making
                ...
                <p className="flex items-start">
                  <span>●</span>
                  <span className="ml-2">
                    Multilingual Support: Fluent understanding of Hausa, Igbo,
                ...
                <p className="flex items-start">
                  <span>●</span>
                  <span className="ml-2">
                    Flexible Pricing: Purchase Units and pay only for what you
                    need – no long-term commitments. With one payment you get
                    accesss to the below integrated tools
                  </span>
                </p>
                <br></br>
                <p className="flex items-start">
                ...
                <div className="ml-5 space-y-2">
                  <p className="flex items-start">
                    <span>●</span>
                    <span className="ml-2">
                      <span className="uppercase text-[#67e8bc]">Afro AI:</span>{" "}
                  ...
                  <p className="flex items-start">
                    ...
                    <span className="ml-2">
                      ...
                      For Medical students, Nurses, and Health Science students
                      to interact with their lecture notes using premium AI.
                    </span>
                  </p>
                </div>
              </motion.div>
