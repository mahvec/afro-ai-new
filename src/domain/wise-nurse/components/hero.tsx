        ...
        <div className="h-screen w-full flex flex-col items-center justify-center bg-[#1a1a2e] text-[#dcf7ee]">
          ...
          >
            ...
            <p className="text-center mb-10">
              ...
              (Anatomy, Physiology, Biochemistry etc) and can answer any
              question about them. That's Wise Nurse! It's a cool new tool that
              uses artificial intelligence to help all medical students (Nurses,
              Medical Students and all Students related to Health Sciences)
                ...
                <div className="ml-5 space-y-2">
                  ...
                  <p className="flex items-start">
                    ...
                    <span className="ml-2">
                      ...
                      resources section to become a Wise Nurse pro
                    </span>
                  </p>
                  <p className="flex items-start">
                    <span>●</span>
                    <span className="ml-2">
                      ...
                      your lecture notes on Wise Nurse.
                    </span>
                  </p>
                </div>
              </motion.div>
